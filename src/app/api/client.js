...
const NO_BRIDGE = { ok: false, available: false, canceled: true, error: "Aira works on YOUR machine's repos — clone github.com/erluxman/bridza, run `pnpm install && pnpm dev`, then open http://app.localhost:5173" };
